...
class ExpandableNotifier extends StatefulWidget {
  ...
  const ExpandableNotifier(
      ...
      required this.child, // An optional key
      super.key,
...
class Expandable extends StatelessWidget {
  ...
  const Expandable({
    required this.collapsed, required this.expanded, super.key,
    this.controller,
    this.theme,
  });
...
class _ExpandableIconState extends State<ExpandableIcon>
  ...
  void initState() {
    ...
    animation = animationController!.drive(Tween<double>(begin: 0, end: 1)
...
class ExpandableButton extends StatelessWidget {
  ...
  const ExpandableButton({required this.onPressed, super.key, this.child, this.theme});
  final Widget? child;
  final ExpandableThemeData? theme;
